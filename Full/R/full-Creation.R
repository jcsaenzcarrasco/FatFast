...
trees  <- read.csv("full.csv")[c(2)]
forest <- read.csv("full.csv")[c(3)]
both   <- read.csv("full.csv")[c(4)]
...
plot( main ="full-FT: Performance creating a forest of 50-node trees" 
    , xrange, yrange
