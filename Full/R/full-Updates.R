...
mergeNo  <- read.csv("full.csv")[c(18)]
mergeInc <- read.csv("full.csv")[c(20)]
insert   <- read.csv("full.csv")[c(22)]
...
plot( main ="full-FT: Updates (insertion and appending) in a forest of 50-node trees" 
    , xrange, yrange
...
lines(lowess(mergeNo + 7)     # lowess (trees)  
