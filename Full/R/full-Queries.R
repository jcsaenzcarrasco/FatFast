...
viewLR <- read.csv("full.csv")[c(7)]
n50    <- read.csv("full.csv")[c(9)]
n75    <- read.csv("full.csv")[c(11)]
n101   <- read.csv("full.csv")[c(13)]
n25    <- read.csv("full.csv")[c(15)]
...
plot( main ="full-FT: Looking up elements in a forest of 50-node trees" 
    , xrange, yrange
...
lines(lowess(viewLR + 35)          # lowess (viewLR)  
