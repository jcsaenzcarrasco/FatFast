...
mergeNo  <- read.csv("seq.csv")[c(18)]
mergeInc <- read.csv("seq.csv")[c(20)]
insert   <- read.csv("seq.csv")[c(22)]

# =======================================  P L O T   L A Y E R  ============ 

xrange = range(0:50)
yrange = range(0:1011000) 

plot( main ="seq-FT: Updates (insertion and appending) in a forest of 50-node trees" 
    , xrange, yrange
...
lines(lowess(mergeNo + 15000)          # lowess (trees)  
