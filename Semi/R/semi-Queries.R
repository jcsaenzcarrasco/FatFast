...
viewLR <- read.csv("semi.csv")[c(7)]
n50    <- read.csv("semi.csv")[c(9)]
n75    <- read.csv("semi.csv")[c(11)]
n101   <- read.csv("semi.csv")[c(13)]
n25    <- read.csv("semi.csv")[c(15)]

# =======================================  P L O T   L A Y E R  ============ 

xrange = range(0:50)
yrange = range(0:1295000) 

plot( main ="semi-FT: Looking up elements in a forest of 50-node trees" 
    , xrange, yrange
...
lines(lowess(viewLR)          # lowess (viewLR)  
