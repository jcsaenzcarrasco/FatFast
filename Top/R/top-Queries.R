...
viewLR <- read.csv("top.csv")[c(7)]
n50    <- read.csv("top.csv")[c(9)]
n75    <- read.csv("top.csv")[c(11)]
n101   <- read.csv("top.csv")[c(13)]
n25    <- read.csv("top.csv")[c(15)]
...
plot( main ="top-FT: Looking up elements in a forest of 50-node trees" 
    , xrange, yrange
...
lines(lowess(viewLR + 3)          # lowess (viewLR)  
